...
<p align="center">
  ...
  <img alt="Version 0.1.6" src="https://img.shields.io/badge/version-0.1.6-lightgrey?style=flat-square">
</p>
...
- **Status:** alpha (v0.1.6). Stable interfaces: the `kernel.py` CLI surface and the cross-stage envelope schema. Unstable: skill internals.

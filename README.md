...
<p align="center">
  ...
  <img alt="Version 0.1.5" src="https://img.shields.io/badge/version-0.1.5-lightgrey?style=flat-square">
</p>
...
|---|---|---|
| `env-precheck` | Pre-pipeline environment check — tools, variables, and a smoke run per license checkout | (probes the installed tools) |
...
- **Status:** alpha (v0.1.5). Stable interfaces: the `kernel.py` CLI surface and the cross-stage envelope schema. Unstable: skill internals.

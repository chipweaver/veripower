class tpu_top_base_test extends uvm_test;
  `uvm_component_utils(tpu_top_base_test)

  tpu_top_env m_env;
  string m_test_id;

  function new(string name = "tpu_top_base_test", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    m_env = tpu_top_env::type_id::create("m_env", this);
  endfunction

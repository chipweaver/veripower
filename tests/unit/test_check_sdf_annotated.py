...
SCRIPT = REPO / "skills" / "power-analysis" / "templates" / "scripts" / "check_sdf_annotated.sh"
...
def test_zero_annotated_fails(tmp_path):
    ...
    assert b"phase=compile category=sdf" in r.stderr  # A: producer self-reports phase too

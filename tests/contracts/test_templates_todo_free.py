...
# (The start-seq branch is inert for *templates* — that marker is emitted by derive_scaffold
# into generated files; the branch is kept so this regex matches Task 3's validate_sim_exit scanner.)

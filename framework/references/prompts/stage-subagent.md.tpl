...
- result.json required fields: stage, module={module}, produced_at (ISO8601 UTC, e.g. 2026-07-12T08:00:00Z — a produced_at predating this run's dispatch is reaped blocked/stale_result), status ∈ {pass, fail}, artifacts, stage_specific.

...
def cmd_dispatch(module, rule, objective, conservative, directive_path, diagnosis_refs):
...
def _derive_triage(module, env, events):
    """Placeholder for Task C7 (simulation-triage reap -> diagnosis derivation, sharing
    the same 4-tuple contract as _derive_verdict). Not reachable from any B3 test: no
    verb here ever dispatches simulation-triage (schedule.py's triage dispatch is B2
    scope; the analysis-writer + this function's real body land in Task C7)."""
    raise NotImplementedError("simulation-triage reap: implemented in Task C7")

...
# rtl_load.tcl is regenerated by bootstrap_synthesis.sh from
# Design/rtl-design/filelist.txt. It contains analyze invocations in dependency
# order; search_path is configured by the set_app_var line above, and any
# +incdir+ directives in the filelist are expanded onto search_path inside
# rtl_load.tcl; -f / +define+ directives are skipped at generation time.

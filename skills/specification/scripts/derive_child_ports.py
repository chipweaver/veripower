...
# Reuse the markdown section/table helpers from the sibling coverage script
# (both survive check_coverage's objective-gate rewrite).
...
def main(workdir: str) -> int:
    print(json.dumps(derive_child_ports(Path(workdir)), ensure_ascii=False, indent=2))
    return 0

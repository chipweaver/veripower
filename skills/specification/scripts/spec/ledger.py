...
must see verbatim at the ledger and partition gate.
"""
...
# Rows the ledger and partition gate shows verbatim: what the author could not place, what the pipeline does
...
def run(workdir: str) -> int:
    """check-ledger: validate requirements.json and print what the ledger and partition gate hands the human."""

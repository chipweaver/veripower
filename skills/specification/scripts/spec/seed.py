#!/usr/bin/env python3
"""spec seed — carry prior canonical specification artifacts into a freeze/rework workdir.
...
On the freeze branch this byte-copies design.md / <child>.md / manifest.json / constraints
AND spec-review.json forward, so a `pin` on the review record survives. First-run (no

...
| `spec-review/` | `requirements.md` (the ledger against the intent document), one review per child, and `decisions.md`, the user's rulings at both gates; delivered and endorsed whole |

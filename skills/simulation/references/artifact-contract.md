...
| `coverage-summary.txt` | A rendering of `case-results.json` for a human. Despite the name it has nothing to do with the coverage gate. |
| `case-results-summary.md` | The other rendering: per-feature traceability and, on a failure, what to open. |

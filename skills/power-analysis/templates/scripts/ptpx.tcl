...
# state-dependent leakage. Kept because the numbers do move at all; if the read ever costs
# more than a third of a percent is worth, that measurement is the argument, not the claim
# it replaced.

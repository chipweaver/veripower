...
fresh plan-adequacy reviewer — as Step 3.5, AFTER `validate_scaffold.py` (structural +
coverage-matrix) passes and BEFORE the Step-4 user review loop. This review is **gating** (T2):

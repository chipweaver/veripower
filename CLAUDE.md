...
- `Design/rtl-design/semantic-review.json` — gating per-child intent-review produced by rtl-design's semantic gate (schema `skills/rtl-design/references/semantic-review.schema.json`).

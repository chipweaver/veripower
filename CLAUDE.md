...
- `Design/rtl-design/semantic-review/<child>.md × N` — one intent review per child, written by a fresh reviewer (contract `skills/rtl-design/references/rtl-review-task-contract.md`); rtl-design's proposed oracle, prose rather than a verdict.
